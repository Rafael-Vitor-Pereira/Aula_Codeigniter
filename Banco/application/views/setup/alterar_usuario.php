			...
			<div class="linha">
				...
				<div class="coluna col6">
					...
					<?php 
						...
						$num2 = rand(0, 9);
						echo form_open('');
						echo form_label('Usuário Antigo:', 'usuario_antigo');
						echo form_input('usuario_antigo');
						echo form_label('Usuário novo:', 'usuario_novo');
						echo form_input('usuario_novo');
						echo form_label('Confirmar Usuário:', 'usuario');
