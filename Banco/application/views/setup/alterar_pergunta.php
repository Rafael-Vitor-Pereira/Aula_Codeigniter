			...
			<div class="linha">
				...
				<div class="coluna col6">
					...
					<?php 
						...
						$num2 = rand(0, 9);
						echo form_open('');
						echo form_label('Pergunta Antiga:', 'pergunta_antiga');
						echo form_input('pergunta_antiga');
						echo form_label('Pergunta Nova:', 'pergunta_nova');
						echo  form_input('pergunta_nova');
						echo form_label('Resposta:', 'resposta');
						echo form_password('resposta');
						echo form_label('Confirmar a resposta:', 'resposta2');
						echo form_password('resposta2');
