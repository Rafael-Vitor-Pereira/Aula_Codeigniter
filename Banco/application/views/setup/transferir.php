			...
			<div class="linha">
				...
				<div class="coluna col6">
					...
					<?php 
						...
						$num2 = rand(0, 9);
						echo form_open('');
						echo form_label('Número da conta destino (sem digito):', 'contadestino');
						echo form_input('contadestino', set_value('contadestino'));
						echo form_label('Digito:', 'digito');
						echo form_input('digito', set_value('digito'));
						echo form_label('Valor:', 'valor');
						echo form_input('valor', set_value('valor'));
						...
						echo form_submit('enviar', 'Enviar Dinheiro', array('class' => 'botao'));
					?>
				</div>
				<div class="coluna col3">&nbsp;</div>
			</div>
